  ...
  return (
    <div className="header">
      <Link to="home" className="home-logo" onClick={() => handleLogoCLick}>
        <img
          style={{ width: "45px" }}
          src="assets/images/gritLogo.png"
          alt=""
        />
        {/* <span>GRIT</span> */}
        <img
          style={{ width: "70px" }}
          src="assets/images/gritNameImg.png"
          alt=""
        />
      </Link>
          ...
          <Nav>
            <ul>
              {menuList.map((menuItem, index) => {
                ...
                return (
                  <li
                    className={menuItem == activeTab ? "selected-style" : ""}
                    key={index}
                  >
                    {" "}
                    <Link
                      to={menuItem.toLowerCase().replace(/ /g, "")}
                      onClick={() => {
      ...
      <div className="search-container">
        ...
        <img
          className="login-btn"
          src="assets/images/loginIcon.svg"
          onClick={handleLogin}
          alt=""
        ></img>
      </div>
