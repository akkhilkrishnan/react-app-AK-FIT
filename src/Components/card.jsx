    ...
    <>
      <div className="card-part">
        ...
        <div className="card-timeline-container">
          <div>
            <div className="card-style">
              <div className="card-heading">
                <div>
                  {workout_obj.workouttype
                    ? day + " " + workout_obj.workouttype + " Workout"
                    : "Frame Workout for the day"}
                </div>
                {showSave && editSaveToggle && (
                  <img
                    className="add-btn"
                    ...
                    return (
                      <div className="workout-container">
                        <div>
                          ...
                          >
                            <span className="sno-style">{i + 1}. </span>
                            {showInput && editIndex == i && !editSaveToggle ? (
                              <TextField
                                id="standard-basic"
                                label="workout"
                                type="text"
              ...
              {workoutList && workoutList.length > 0 && (
                <div className="timing-style">
                  <div>
                    <p>ON time:{" " + workout_obj.onTime}</p>
                    <p>OFF time:{" " + workout_obj.offTime}</p>
                  </div>
                  <div>
                    <p>Sets:{" " + workout_obj.sets}</p>
                    <p>Laps :{" " + workout_obj.laps}</p>
                  </div>
                </div>
              )}
            </div>
          ...
          <SaveActions
            oneWeekWorkout={oneWeekWorkout}
            multiWeekArr={multiWeekArr}
            storeoneWeekWorkouts={storeoneWeekWorkouts}
            month={month}
          />
        </div>
      </div>
